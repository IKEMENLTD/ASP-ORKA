<?php
	...
	class Api_core
	{
		...
		{
			global $gm;
			print $gm['adwares']->getCCResult( null, '<!--# code tableSelectForm adwares adwares name id  未選択 #-->' );
		}
		...
		{
			global $gm;
			print $gm['secretAdwares']->getCCResult( null, '<!--# code tableSelectForm adwares secretAdwares name id  未選択 #-->' );
		}
